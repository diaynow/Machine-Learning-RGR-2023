...
st.write(
    "Выбранный мной набор данных содержит информацию о мошенничестве с кридитными картами"
)
...
st.write(
    "2. distance_from_last_transaction - расстояние от места совершения последней транзакции"
)
st.write(
    "3. ratio_to_median_purchase_price - отношение стоимости совершенной сделки к медиане покупной цены"
)
st.write(
    "4. repeat_retailer - транзакция произошла от того же розничного продавца (0,1)"
)
...
st.write(
    "2. Переведены в целочисленный тип данных следующие признаки: fraud, online_order, used_pin_number, used_chip, repeat_retailer"
)
st.write(
    "3. Удалены выбросы для признаков: distance_from_home, distance_from_last_transaction, ratio_to_median_purchase_price"
)
